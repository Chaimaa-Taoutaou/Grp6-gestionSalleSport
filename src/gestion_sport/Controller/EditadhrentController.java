...
public class EditadhrentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            cin.setText(AdhérentController.b);
            nom.setText(AdhérentController.a);
            prenom.setText(AdhérentController.c);
            tel.setText(AdhérentController.d);
            adr.setText(AdhérentController.g);
    ...
    public void editadr(MouseEvent mouseEvent) {
        ...
        String req = "UPDATE `adhrent` SET `cin`='" + cN + "', `nom`='" + n + "', `prenom`='" + p + "',sexe='"+radioButtonLabel+"', `tel`='" + t + "', `adresse`='" + ar + "',`date_register`='" + d + "', `id_abon`=" + sform[0] + " where id_a="+AdhérentController.idad+"";
        if (n.isEmpty() || cN.isEmpty() || p.isEmpty() || ar.isEmpty() || t.isEmpty()) {
            ...
            if (c.addadhr(req) == true) {
               ...
               // alert.setContentText("ssayez de remplire tous les champs");
