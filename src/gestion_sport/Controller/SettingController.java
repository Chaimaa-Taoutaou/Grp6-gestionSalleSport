...
public class SettingController implements Initializable {
    ...
    public void updatuser() {
        int id = c.recupid(m);
        if (p.getText().equals(passn.getText())) {
            String req = "UPDATE admin set usernam='" + username.getText() + "' ,passsword='" + p.getText() + "' where id=" + id + "";
        System.out.println( id);
            System.out.println( p+"   "+passn);
            if (c.updatuser(req)) {
                ...
                alert.setTitle("");
                alert.setHeaderText(null);
                alert.setContentText("vos informations sont modifieesXD");
